...
<img src="https://github.com/SelfExplainML/PiML-Toolbox/blob/main/examples/results/LogoPiML.png" alt="drawing"/>

**A low-code interpretable machine learning library in Python** 
</div>
