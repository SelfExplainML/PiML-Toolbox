...
exp.model_explain(model="XGB-External-2", show="pfi", uni_feature="MedInc", figsize=(5, 4))
...
exp.model_diagnose(model="XGB-External-7", show="weakspot", slice_features=["MedInc"], figsize=(5, 4))
